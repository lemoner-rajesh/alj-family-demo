...
// A third visual treatment of the same data — a dark, colorful org-chart
// styled after popular family-tree builder tools (gender-coded cards,
// initials avatars, floating search) instead of a plain diagram.
export default function Option3Page({ onBack }) {
