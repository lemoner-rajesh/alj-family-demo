...
// Standalone alternate page — same tree/timeline app as HomePage.jsx, just
// rendered over a video background with a dark overlay instead of the
// plain white background. Deliberately a full copy rather than a shared
// component with a "hasVideoBg" flag: HomePage.jsx stays untouched, and
// this page can be removed later without touching it either.
export default function VideoOptionPage() {
  ...
  return (
    <div className="app video-page">
      <video
        className="video-page__bg"
        src="https://uat.thejameelfamily.com/static/jameel-family-5b148c85f1a6d10385c776f5c4d916a3.webm"
        autoPlay
        loop
        muted
        playsInline
        aria-hidden="true"
      />
      <div className="video-page__overlay" aria-hidden="true" />
