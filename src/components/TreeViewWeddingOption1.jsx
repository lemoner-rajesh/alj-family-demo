...
import CoupleUnitWeddingOption1 from "./CoupleUnitWeddingOption1";
...
// Identical to TreeView.jsx except it renders CoupleUnitWeddingOption1
...
export default function TreeViewWeddingOption1({ root, collapsed, onToggle, selectedId, onSelect, query, forceOpenIds }) {
